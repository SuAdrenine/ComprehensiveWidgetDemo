...
- (void)viewDidLoad {
    ...
    [_button addTarget:self action:@selector(turnToMainPage:) forControlEvents:UIControlEventTouchUpInside];
}
...
-(void)turnToMainPage:(id)sender {
    [self presentViewController:[RootViewController new] animated:YES completion:^{
    }];
}
